                            ...
                            <>
                                ...
                                {shouldShow('draftStarters') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.openchamber.visual.field.showDraftStarters')}
                                        ariaLabel={t('settings.openchamber.visual.field.showDraftStartersAria')}
                                        settingsItem="chat.draft-starters"
                                    />
                                )}
                    ...
                    <SettingsSection title={t('settings.openchamber.visual.section.privacy')}>
                        ...
                        {shouldShow('allowSessionSharing') && (
                            <SettingsCheckboxRow
                                ...
                                label={t('settings.openchamber.visual.field.allowSessionSharing')}
                                info={t('settings.openchamber.visual.field.allowSessionSharingHint')}
                                ariaLabel={t('settings.openchamber.visual.field.allowSessionSharingAria')}
                                settingsItem="appearance.session-sharing"
                            />
                        )}
                    </SettingsSection>
                )}
