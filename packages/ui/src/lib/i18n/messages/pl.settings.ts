export const settingsDict = {
  ...
  'settings.github.page.actions.copyCode': 'Kopiuj kod',
  ...
  'settings.github.page.toast.codeCopied': 'Skopiowano kod do schowka',
  'settings.github.page.toast.connected': 'Połączono z GitHub',
  'settings.github.page.toast.copyCodeFailed': 'Nie udało się skopiować kodu',
  ...
  'settings.magicPrompts.page.loading.text': 'Ładowanie Promptów systemowych...',
  ...
  'settings.magicPrompts.page.toast.loadFailed': 'Nie udało się załadować Promptów systemowych',
  ...
  'settings.magicPrompts.page.toast.saveFailed': 'Nie udało się zapisać systemowego promptu',
  'settings.magicPrompts.page.toast.saved': 'Prompt systemowy został zapisany',
  ...
  'settings.magicPrompts.sidebar.title': 'Prompty systemowe',
  ...
  'settings.openchamber.defaults.modelRouter.title': 'Router automatyczny',
  'settings.openchamber.defaults.modelRouter.description': 'Gdy jako model wybrano „Auto”, tani model obsługuje proste wiadomości, a silniejszy model obsługuje te złożone.',
  'settings.openchamber.defaults.modelRouter.cheapModel': 'Model warstwy taniej',
  'settings.openchamber.defaults.modelRouter.cheapModelHint': 'Taki sam jak mały model',
  'settings.openchamber.defaults.modelRouter.frontierModel': 'Model warstwy zaawansowanej',
  'settings.openchamber.defaults.modelRouter.frontierModelHint': 'Taki sam jak model domyślny',
  ...
  'settings.openchamber.defaults.openInApp.title': 'Otwórz w',
  'settings.openchamber.defaults.openInApp.description': 'Domyślna aplikacja używana podczas otwierania projektu z OpenChamber.',
  'settings.openchamber.defaults.field.defaultOpenInApp': 'Domyślna aplikacja',
  'settings.openchamber.defaults.field.defaultOpenInAppAria': 'Wybierz domyślną aplikację do otwierania projektów',
  ...
  'settings.openchamber.cloud.title': 'Maszyny wirtualne w chmurze',
  'settings.openchamber.cloud.tooltip': 'Uruchom sesję czatu na efemerycznej maszynie wirtualnej w chmurze zamiast na komputerze lokalnym. Wymaga własnej infrastruktury provisioningowej — OpenChamber wywołuje tylko skonfigurowane tutaj webhooki.',
  'settings.openchamber.cloud.field.enabled': 'Włącz maszyny wirtualne w chmurze',
  'settings.openchamber.cloud.field.enabledAria': 'Włącz maszyny wirtualne w chmurze',
  'settings.openchamber.cloud.field.provisionWebhookUrl': 'Adres URL webhooka provisioningu',
  'settings.openchamber.cloud.field.provisionWebhookUrlPlaceholder': 'https://infra.example.com/provision',
  'settings.openchamber.cloud.field.destroyWebhookUrl': 'Adres URL webhooka usuwania',
  'settings.openchamber.cloud.field.destroyWebhookUrlPlaceholder': 'https://infra.example.com/destroy',
  'settings.openchamber.cloud.field.webhookAuthToken': 'Token uwierzytelniający webhooka',
  'settings.openchamber.cloud.field.webhookAuthTokenPlaceholder': 'Wprowadź token',
  'settings.openchamber.cloud.field.webhookAuthTokenSetPlaceholder': 'Token jest ustawiony — pozostaw puste, aby go zachować',
  'settings.openchamber.cloud.field.idleTimeoutMinutes': 'Limit bezczynności (minuty)',
  'settings.openchamber.cloud.field.maxLifetimeMinutes': 'Maksymalny czas życia (minuty)',
  'settings.openchamber.cloud.actions.save': 'Zapisz',
  'settings.openchamber.cloud.actions.clearToken': 'Wyczyść',
  'settings.openchamber.cloud.toast.saved': 'Zapisano ustawienia maszyn wirtualnych w chmurze',
  'settings.openchamber.cloud.toast.saveFailed': 'Nie udało się zapisać ustawień maszyn wirtualnych w chmurze',
  'settings.openchamber.cloud.toast.tokenCleared': 'Token uwierzytelniający webhooka wyczyszczony',
  ...
  'settings.openchamber.visual.field.showDraftStarters': 'Pokaż podpowiedzi startowe',
  'settings.openchamber.visual.field.showDraftStartersAria': 'Pokaż podpowiedzi startowe',
  ...
  'settings.openchamber.visual.field.allowSessionSharingAria': 'Zezwalaj na udostępnianie sesji',
  'settings.openchamber.visual.field.allowSessionSharing': 'Zezwalaj na udostępnianie sesji',
  'settings.openchamber.visual.field.allowSessionSharingHint': 'Gdy ta opcja jest włączona, funkcja Udostępnij może przesłać całą sesję czatu do usługi hostowanej OpenCode i wygenerować publiczny link. Domyślnie wyłączone.',
  ...
  'settings.page.magicPrompts.title': 'Prompty systemowe',
  ...
  'settings.page.cloud.title': 'Maszyny wirtualne w chmurze',
...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.usage.page.empty.noProvidersConfigured': 'Nie skonfigurowano jeszcze żadnych dostawców. Dodaj dane uwierzytelniające w zakładce Dostawcy, aby rozpocząć śledzenie użycia.',
  ...
  'settings.usage.sidebar.empty.noProvidersConfigured': 'Nie skonfigurowano jeszcze żadnych dostawców.',
