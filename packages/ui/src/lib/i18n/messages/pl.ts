...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.chatInput.branches': 'Gałęzie',
  ...
  'chat.chatInput.draftPicker.newBranchTitle': 'Nowa gałąź',
  'chat.chatInput.draftPicker.newPlainBranchTitle': 'Utwórz gałąź',
  ...
  'chat.chatInput.worktreeNewBranchPlaceholder': 'Nazwa gałęzi',
  'chat.chatInput.worktreeNewBranchAria': 'Nazwa nowej gałęzi',
  'chat.chatInput.worktrees': 'Drzewa pracy',
  'chat.chatInput.branchNew': '+ Nowe',
  'chat.chatInput.toast.createBranchFailed': 'Nie udało się utworzyć gałęzi',
  ...
  'chat.modelControls.instanceSwitcher.openAria': 'Przełącz instancję (bieżąca: {current})',
  'chat.modelControls.instanceSwitcher.tooltip': 'Instancja: {current}',
  ...
  'chat.modelControls.autoModel': 'Automatyczny',
  ...
  'sessions.sidebar.footer.github.accountsTitle': 'Konta GitHub',
  'sessions.sidebar.footer.github.accountSource.oauth': 'OAuth',
  'sessions.sidebar.footer.github.accountSource.cli': 'CLI',
  'sessions.sidebar.footer.github.avatar': 'Awatar GitHub',
  'sessions.sidebar.footer.github.avatarWithLogin': 'Awatar {login}',
  'sessions.sidebar.footer.github.connected': 'GitHub połączony',
  ...
  'projectActions.actions.discoverActionsTooltip': 'Wykryj akcje',
  ...
  'session.newWorktree.actions.createCloudSession': 'Utwórz sesję w chmurze',
  'session.newWorktree.actions.createWorktree': 'Utwórz drzewo pracy',
  'session.newWorktree.actions.creating': 'Tworzenie...',
  'session.newWorktree.actions.provisioning': 'Udostępnianie...',
  ...
  'session.newWorktree.backend.cloud': 'Chmura',
  'session.newWorktree.backend.cloudUnavailableTooltip': 'Chmura wymaga, aby ta gałąź została wypchnięta do zdalnego repozytorium — jeszcze tak nie jest.',
  'session.newWorktree.backend.label': 'Backend',
  'session.newWorktree.backend.local': 'Lokalnie',
  ...
  'session.newWorktree.error.cloudProvisioningFailed': 'Nie udało się udostępnić maszyny wirtualnej w chmurze',
  ...
  'session.newWorktree.error.noRemoteUrl': 'Nie udało się ustalić zdalnego adresu URL tego repozytorium',
  ...
  'session.newWorktree.toast.cloudSessionCreated': 'Utworzono sesję w chmurze',
  ...
  'appUpdate.toast.available.title': 'Dostępna aktualizacja OpenChamber',
  'appUpdate.toast.available.description': 'Wersja {version} jest gotowa do instalacji.',
  'appUpdate.toast.actions.view': 'Zobacz aktualizację',
  'appUpdate.toast.actions.dismiss': 'Odrzuć',
