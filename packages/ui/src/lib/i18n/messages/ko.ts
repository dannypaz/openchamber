...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.footer.github.connected': 'GitHub 연결됨',
  'sessions.sidebar.footer.github.avatarWithLogin': '{login} 아바타',
  'sessions.sidebar.footer.github.avatar': 'GitHub 아바타',
  ...
  'session.newWorktree.actions.createCloudSession': '클라우드 세션 생성',
  'session.newWorktree.actions.provisioning': '프로비저닝 중…',
  'session.newWorktree.actions.reset': '초기화',
  'session.newWorktree.backend.label': '백엔드',
  'session.newWorktree.backend.local': '로컬',
  'session.newWorktree.backend.cloud': '클라우드',
  'session.newWorktree.backend.cloudUnavailableTooltip': '클라우드를 사용하려면 이 브랜치가 원격 저장소에 푸시되어 있어야 합니다 — 아직 푸시되지 않았습니다.',
  ...
  'session.newWorktree.error.noRemoteUrl': '이 저장소의 원격 URL을 확인할 수 없습니다',
  'session.newWorktree.error.cloudProvisioningFailed': '클라우드 VM 프로비저닝에 실패했습니다',
  ...
  'session.newWorktree.toast.cloudSessionCreated': '클라우드 세션을 생성했습니다',
  ...
  'chat.chatInput.draftPicker.newBranchTitle': '새 브랜치',
  'chat.chatInput.draftPicker.newPlainBranchTitle': '브랜치 만들기',
  'chat.chatInput.worktrees': '워크트리',
  'chat.chatInput.worktreeNew': '+ 새로 만들기',
  'chat.chatInput.worktreeNewBranchPlaceholder': '브랜치 이름',
  'chat.chatInput.worktreeNewBranchAria': '새 브랜치 이름',
  'chat.chatInput.branchNew': '+ 새로 만들기',
  'chat.chatInput.toast.createBranchFailed': '브랜치 생성에 실패했습니다',
  ...
  'chat.modelControls.instanceSwitcher.openAria': '인스턴스 전환(현재: {current})',
  'chat.modelControls.instanceSwitcher.tooltip': '인스턴스: {current}',
  ...
  'appUpdate.toast.available.title': 'OpenChamber 업데이트 사용 가능',
  'appUpdate.toast.available.description': '버전 {version} 설치 준비가 완료되었습니다.',
  'appUpdate.toast.actions.view': '업데이트 보기',
  'appUpdate.toast.actions.dismiss': '닫기',
