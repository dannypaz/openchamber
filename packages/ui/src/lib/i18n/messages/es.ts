...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.sidebar.footer.github.connectedWithLogin": "GitHub: {login}",
  "sessions.sidebar.footer.github.connected": "Conectado a GitHub",
  "sessions.sidebar.footer.github.avatarWithLogin": "Avatar de {login}",
  "sessions.sidebar.footer.github.avatar": "Avatar de GitHub",
  "sessions.sidebar.footer.github.accountsTitle": "Cuentas de GitHub",
  "sessions.sidebar.footer.github.accountSource.oauth": "OAuth",
  "sessions.sidebar.footer.github.accountSource.cli": "CLI",
  "header.instanceSwitcher.tooltip": "Instancia: {current}",
  ...
  "chat.cloudSession.unavailable.title": "VM en la nube no disponible",
  "chat.cloudSession.unavailable.description": "La VM en la nube de esta sesión ya no está en ejecución. Es posible que se haya detenido o que se haya alcanzado el tiempo de espera de inactividad.",
  ...
  "aboutDialog.actions.updateAvailable": "Actualizar a {version}",
  ...
  "session.newWorktree.actions.createCloudSession": "Crear sesión en la nube",
  "session.newWorktree.actions.provisioning": "Aprovisionando...",
  "session.newWorktree.actions.reset": "Restablecer",
  "session.newWorktree.backend.label": "Backend",
  "session.newWorktree.backend.local": "Local",
  "session.newWorktree.backend.cloud": "Nube",
  "session.newWorktree.backend.cloudUnavailableTooltip": "La nube requiere que esta rama esté publicada en un remoto; todavía no lo está.",
  ...
  "session.newWorktree.error.noRemoteUrl": "No se pudo determinar la URL remota de este repositorio",
  "session.newWorktree.error.cloudProvisioningFailed": "No se pudo aprovisionar la VM en la nube",
  ...
  "session.newWorktree.toast.cloudSessionCreated": "Sesión en la nube creada",
  ...
  "chat.chatInput.draftPicker.newBranchTitle": "Nueva rama",
  "chat.chatInput.draftPicker.newPlainBranchTitle": "Crear rama",
  "chat.chatInput.worktrees": "Worktrees",
  "chat.chatInput.worktreeNew": "+ Nuevo",
  "chat.chatInput.worktreeNewBranchPlaceholder": "Nombre de la rama",
  "chat.chatInput.worktreeNewBranchAria": "Nombre de la nueva rama",
  "chat.chatInput.branchNew": "+ Nuevo",
  "chat.chatInput.toast.createBranchFailed": "Error al crear la rama",
  ...
  "chat.modelControls.autoModel": "Automático",
  ...
  "chat.modelControls.instanceSwitcher.openAria": "Cambiar instancia (actual: {current})",
  "chat.modelControls.instanceSwitcher.tooltip": "Instancia: {current}",
  ...
  "projectActions.actions.discoverActionsTooltip": "Descubrir acciones",
  ...
  "appUpdate.toast.available.title": "Actualización de OpenChamber disponible",
  "appUpdate.toast.available.description": "La versión {version} está lista para instalar.",
  "appUpdate.toast.actions.view": "Ver actualización",
  "appUpdate.toast.actions.dismiss": "Descartar",
