export const settingsDict = {
  ...
  "settings.page.magicPrompts.title": "Системні промпти",
  ...
  "settings.page.cloud.title": "Хмарні ВМ",
  ...
  "settings.magicPrompts.sidebar.title": "Системні промпти",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.openchamber.cloud.title": "Хмарні ВМ",
  "settings.openchamber.cloud.tooltip": "Запустіть сеанс чату на тимчасовій хмарній ВМ замість локального комп'ютера. Потрібна власна інфраструктура для розгортання — OpenChamber лише викликає вебхуки, які ви налаштуєте тут.",
  "settings.openchamber.cloud.field.enabled": "Увімкнути хмарні ВМ",
  "settings.openchamber.cloud.field.enabledAria": "Увімкнути хмарні ВМ",
  "settings.openchamber.cloud.field.provisionWebhookUrl": "URL вебхука розгортання",
  "settings.openchamber.cloud.field.provisionWebhookUrlPlaceholder": "https://infra.example.com/provision",
  "settings.openchamber.cloud.field.destroyWebhookUrl": "URL вебхука видалення",
  "settings.openchamber.cloud.field.destroyWebhookUrlPlaceholder": "https://infra.example.com/destroy",
  "settings.openchamber.cloud.field.webhookAuthToken": "Токен автентифікації вебхука",
  "settings.openchamber.cloud.field.webhookAuthTokenPlaceholder": "Введіть токен",
  "settings.openchamber.cloud.field.webhookAuthTokenSetPlaceholder": "Токен уже встановлено — залиште порожнім, щоб зберегти його",
  "settings.openchamber.cloud.field.idleTimeoutMinutes": "Тайм-аут бездіяльності (хвилини)",
  "settings.openchamber.cloud.field.maxLifetimeMinutes": "Максимальний час життя (хвилини)",
  "settings.openchamber.cloud.actions.save": "Зберегти",
  "settings.openchamber.cloud.actions.clearToken": "Очистити",
  "settings.openchamber.cloud.toast.saved": "Налаштування хмарних ВМ збережено",
  "settings.openchamber.cloud.toast.saveFailed": "Не вдалося зберегти налаштування хмарних ВМ",
  "settings.openchamber.cloud.toast.tokenCleared": "Токен автентифікації вебхука очищено",
  ...
  "settings.usage.sidebar.empty.noProvidersConfigured": "Ще не налаштовано жодного провайдера.",
  "settings.usage.page.empty.selectProvider": "Виберіть провайдера, щоб переглянути деталі використання.",
  "settings.usage.page.empty.noProvidersConfigured": "Ще не налаштовано жодного провайдера. Додайте облікові дані на вкладці Провайдери, щоб почати відстеження використання.",
  ...
  "settings.openchamber.defaults.modelRouter.title": "Автоматичний маршрутизатор",
  "settings.openchamber.defaults.modelRouter.description": "Коли як модель вибрано «Авто», прості повідомлення обробляє дешева модель, а складні — потужніша модель.",
  "settings.openchamber.defaults.modelRouter.cheapModel": "Модель дешевого рівня",
  "settings.openchamber.defaults.modelRouter.cheapModelHint": "Так само, як мала модель",
  "settings.openchamber.defaults.modelRouter.frontierModel": "Модель просунутого рівня",
  "settings.openchamber.defaults.modelRouter.frontierModelHint": "Так само, як модель за замовчуванням",
  ...
  "settings.openchamber.defaults.openInApp.title": "Відкривати в",
  "settings.openchamber.defaults.openInApp.description": "Застосунок за замовчуванням, який використовується під час відкриття проєкту з OpenChamber.",
  "settings.openchamber.defaults.field.defaultOpenInApp": "Застосунок за замовчуванням",
  "settings.openchamber.defaults.field.defaultOpenInAppAria": "Виберіть застосунок за замовчуванням для відкриття проєктів",
  ...
  "settings.github.page.actions.copyCode": "Копіювати код",
  ...
  "settings.github.page.toast.codeCopied": "Код скопійовано в буфер обміну",
  "settings.github.page.toast.copyCodeFailed": "Не вдалося скопіювати код",
  ...
  "settings.openchamber.visual.field.showDraftStartersAria": "Показувати стартери чернетки",
  "settings.openchamber.visual.field.showDraftStarters": "Показувати стартери чернетки",
  ...
  "settings.openchamber.visual.field.allowSessionSharingAria": "Дозволити спільний доступ до сеансу",
  "settings.openchamber.visual.field.allowSessionSharing": "Дозволити спільний доступ до сеансу",
  "settings.openchamber.visual.field.allowSessionSharingHint": "Якщо ввімкнено, опція «Поділитися» може завантажити весь сеанс чату до розміщеної служби OpenCode та створити публічне посилання. За замовчуванням вимкнено.",
  ...
  "settings.magicPrompts.page.loading.text": "Завантаження системних промптів...",
  ...
  "settings.magicPrompts.page.toast.loadFailed": "Не вдалося завантажити системні промпти",
  "settings.magicPrompts.page.toast.visiblePromptRequired": "Видиме повідомлення не може бути порожнім",
  "settings.magicPrompts.page.toast.saved": "Системний промпт збережено",
  "settings.magicPrompts.page.toast.saveFailed": "Не вдалося зберегти системний промпт",
