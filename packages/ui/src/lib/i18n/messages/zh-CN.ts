...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.footer.github.connected': 'GitHub 已连接',
  'sessions.sidebar.footer.github.avatarWithLogin': '{login} 头像',
  'sessions.sidebar.footer.github.avatar': 'GitHub 头像',
  ...
  'chat.cloudSession.unavailable.title': '云虚拟机不可用',
  'chat.cloudSession.unavailable.description': '此会话的云虚拟机已不再运行。它可能已被停止,或已达到空闲超时。',
  ...
  'session.newWorktree.actions.createCloudSession': '创建云会话',
  'session.newWorktree.actions.provisioning': '正在配置...',
  'session.newWorktree.actions.reset': '重置',
  'session.newWorktree.backend.label': '后端',
  'session.newWorktree.backend.local': '本地',
  'session.newWorktree.backend.cloud': '云端',
  'session.newWorktree.backend.cloudUnavailableTooltip': '云端要求此分支已推送到远程仓库——目前尚未推送。',
  ...
  'session.newWorktree.error.noRemoteUrl': '无法确定此仓库的远程 URL',
  'session.newWorktree.error.cloudProvisioningFailed': '配置云虚拟机失败',
  ...
  'session.newWorktree.toast.cloudSessionCreated': '云会话已创建',
  ...
  'chat.chatInput.draftPicker.newBranchTitle': '新建分支',
  'chat.chatInput.draftPicker.newPlainBranchTitle': '创建分支',
  'chat.chatInput.worktrees': '工作树',
  'chat.chatInput.worktreeNew': '+ 新建',
  'chat.chatInput.worktreeNewBranchPlaceholder': '分支名称',
  'chat.chatInput.worktreeNewBranchAria': '新分支名称',
  'chat.chatInput.branchNew': '+ 新建',
  'chat.chatInput.toast.createBranchFailed': '创建分支失败',
  ...
  'chat.modelControls.instanceSwitcher.openAria': '切换实例（当前：{current}）',
  'chat.modelControls.instanceSwitcher.tooltip': '实例：{current}',
  ...
  'updateDialog.status.restarting': '正在重启...',
  ...
  'appUpdate.toast.available.description': '版本 {version} 已准备好安装。',
