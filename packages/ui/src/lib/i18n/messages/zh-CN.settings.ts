export const settingsDict = {
  ...
  'settings.page.magicPrompts.title': '系统提示词',
  ...
  'settings.page.cloud.title': '云虚拟机',
  ...
  'settings.magicPrompts.sidebar.title': '系统提示词',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.cloud.title': '云虚拟机',
  'settings.openchamber.cloud.tooltip': '在临时云虚拟机上运行聊天会话，而不是在本地机器上运行。需要您自己的资源调配基础设施——OpenChamber 仅调用您在此处配置的 Webhook。',
  'settings.openchamber.cloud.field.enabled': '启用云虚拟机',
  'settings.openchamber.cloud.field.enabledAria': '启用云虚拟机',
  'settings.openchamber.cloud.field.provisionWebhookUrl': '创建 Webhook URL',
  'settings.openchamber.cloud.field.provisionWebhookUrlPlaceholder': 'https://infra.example.com/provision',
  'settings.openchamber.cloud.field.destroyWebhookUrl': '销毁 Webhook URL',
  'settings.openchamber.cloud.field.destroyWebhookUrlPlaceholder': 'https://infra.example.com/destroy',
  'settings.openchamber.cloud.field.webhookAuthToken': 'Webhook 认证令牌',
  'settings.openchamber.cloud.field.webhookAuthTokenPlaceholder': '输入令牌',
  'settings.openchamber.cloud.field.webhookAuthTokenSetPlaceholder': '令牌已设置——留空以保留',
  'settings.openchamber.cloud.field.idleTimeoutMinutes': '空闲超时（分钟）',
  'settings.openchamber.cloud.field.maxLifetimeMinutes': '最长存活时间（分钟）',
  'settings.openchamber.cloud.actions.save': '保存',
  'settings.openchamber.cloud.actions.clearToken': '清除',
  'settings.openchamber.cloud.toast.saved': '云虚拟机设置已保存',
  'settings.openchamber.cloud.toast.saveFailed': '保存云虚拟机设置失败',
  'settings.openchamber.cloud.toast.tokenCleared': 'Webhook 认证令牌已清除',
  ...
  'settings.usage.sidebar.empty.noProvidersConfigured': '尚未设置任何提供商。',
  'settings.usage.page.empty.selectProvider': '选择一个提供商以查看用量详情。',
  'settings.usage.page.empty.noProvidersConfigured': '尚未设置任何提供商。请在"提供商"标签页中添加凭据以开始跟踪用量。',
  ...
  'settings.openchamber.defaults.modelRouter.title': '自动路由',
  'settings.openchamber.defaults.modelRouter.description': '当模型选择为"自动"时，简单消息由经济型模型处理，复杂消息由更强的模型处理。',
  'settings.openchamber.defaults.modelRouter.cheapModel': '经济层模型',
  'settings.openchamber.defaults.modelRouter.cheapModelHint': '与小模型相同',
  'settings.openchamber.defaults.modelRouter.frontierModel': '高级层模型',
  'settings.openchamber.defaults.modelRouter.frontierModelHint': '与默认模型相同',
  ...
  'settings.openchamber.defaults.openInApp.title': '打开方式',
  'settings.openchamber.defaults.openInApp.description': '从 OpenChamber 打开项目时使用的默认应用。',
  'settings.openchamber.defaults.field.defaultOpenInApp': '默认应用',
  'settings.openchamber.defaults.field.defaultOpenInAppAria': '选择用于打开项目的默认应用',
  ...
  'settings.github.page.actions.copyCode': '复制代码',
  ...
  'settings.github.page.toast.codeCopied': '代码已复制到剪贴板',
  'settings.github.page.toast.copyCodeFailed': '复制代码失败',
  ...
  'settings.openchamber.visual.field.showDraftStartersAria': '显示草稿启动器',
  'settings.openchamber.visual.field.showDraftStarters': '显示草稿启动器',
  ...
  'settings.openchamber.visual.field.allowSessionSharingAria': '允许分享会话',
  'settings.openchamber.visual.field.allowSessionSharing': '允许分享会话',
  'settings.openchamber.visual.field.allowSessionSharingHint': '启用后，"分享"选项可以将整个聊天会话上传到 OpenCode 的托管服务并生成公开链接。默认关闭。',
  ...
  'settings.magicPrompts.page.loading.text': '正在加载系统提示词...',
  ...
  'settings.magicPrompts.page.toast.loadFailed': '加载系统提示词失败',
  'settings.magicPrompts.page.toast.visiblePromptRequired': '可见提示词不能为空',
  'settings.magicPrompts.page.toast.saved': '系统提示词已保存',
  'settings.magicPrompts.page.toast.saveFailed': '保存系统提示词失败',
