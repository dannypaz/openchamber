...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.session.share.disabled': '工作階段分享已停用。請在設定中啟用後再分享工作階段。',
  ...
  'sessions.sidebar.footer.github.connected': 'GitHub 已連線',
  'sessions.sidebar.footer.github.avatarWithLogin': '{login} 頭像',
  'sessions.sidebar.footer.github.avatar': 'GitHub 頭像',
  'sessions.sidebar.footer.github.accountsTitle': 'GitHub 帳戶',
  'sessions.sidebar.footer.github.accountSource.oauth': 'OAuth',
  'sessions.sidebar.footer.github.accountSource.cli': 'CLI',
  'header.instanceSwitcher.tooltip': '實例：{current}',
  ...
  'session.newWorktree.actions.createCloudSession': '建立雲端工作階段',
  'session.newWorktree.actions.provisioning': '佈建中...',
  'session.newWorktree.actions.reset': '重設',
  'session.newWorktree.backend.label': '後端',
  'session.newWorktree.backend.local': '本機',
  'session.newWorktree.backend.cloud': '雲端',
  'session.newWorktree.backend.cloudUnavailableTooltip': '雲端功能需要此分支已推送到遠端——目前尚未推送。',
  ...
  'session.newWorktree.error.noRemoteUrl': '無法判斷此儲存庫的遠端 URL',
  'session.newWorktree.error.cloudProvisioningFailed': '佈建雲端虛擬機失敗',
  ...
  'session.newWorktree.toast.cloudSessionCreated': '雲端工作階段已建立',
  ...
  'chat.chatInput.draftPicker.newBranchTitle': '新增分支',
  'chat.chatInput.draftPicker.newPlainBranchTitle': '建立分支',
  'chat.chatInput.worktrees': 'Worktree',
  'chat.chatInput.worktreeNew': '+ 新增',
  'chat.chatInput.worktreeNewBranchPlaceholder': '分支名稱',
  'chat.chatInput.worktreeNewBranchAria': '新分支名稱',
  'chat.chatInput.branchNew': '+ 新增',
  'chat.chatInput.toast.createBranchFailed': '建立分支失敗',
  ...
  'chat.modelControls.instanceSwitcher.openAria': '切換實例（目前：{current}）',
  'chat.modelControls.instanceSwitcher.tooltip': '實例：{current}',
  ...
  'updateDialog.status.restarting': '正在重新啟動...',
  ...
  'appUpdate.toast.available.title': 'OpenChamber 更新可用',
  'appUpdate.toast.available.description': '版本 {version} 已準備好安裝。',
  'appUpdate.toast.actions.view': '查看更新',
  'appUpdate.toast.actions.dismiss': '忽略',
