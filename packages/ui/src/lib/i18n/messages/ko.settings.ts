export const settingsDict = {
  ...
  'settings.page.magicPrompts.title': '시스템 프롬프트',
  ...
  'settings.page.cloud.title': '클라우드 VM',
  ...
  'settings.magicPrompts.sidebar.title': '시스템 프롬프트',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.cloud.title': '클라우드 VM',
  'settings.openchamber.cloud.tooltip': '로컬 머신 대신 임시 클라우드 VM에서 채팅 세션을 실행합니다. 자체 프로비저닝 인프라가 필요합니다. OpenChamber는 여기서 설정한 웹훅만 호출합니다.',
  'settings.openchamber.cloud.field.enabled': '클라우드 VM 활성화',
  'settings.openchamber.cloud.field.enabledAria': '클라우드 VM 활성화',
  'settings.openchamber.cloud.field.provisionWebhookUrl': '프로비저닝 웹훅 URL',
  'settings.openchamber.cloud.field.provisionWebhookUrlPlaceholder': 'https://infra.example.com/provision',
  'settings.openchamber.cloud.field.destroyWebhookUrl': '삭제 웹훅 URL',
  'settings.openchamber.cloud.field.destroyWebhookUrlPlaceholder': 'https://infra.example.com/destroy',
  'settings.openchamber.cloud.field.webhookAuthToken': '웹훅 인증 토큰',
  'settings.openchamber.cloud.field.webhookAuthTokenPlaceholder': '토큰 입력',
  'settings.openchamber.cloud.field.webhookAuthTokenSetPlaceholder': '토큰이 설정되어 있습니다 — 유지하려면 비워 두세요',
  'settings.openchamber.cloud.field.idleTimeoutMinutes': '유휴 시간 제한(분)',
  'settings.openchamber.cloud.field.maxLifetimeMinutes': '최대 수명(분)',
  'settings.openchamber.cloud.actions.save': '저장',
  'settings.openchamber.cloud.actions.clearToken': '지우기',
  'settings.openchamber.cloud.toast.saved': '클라우드 VM 설정이 저장되었습니다',
  'settings.openchamber.cloud.toast.saveFailed': '클라우드 VM 설정 저장에 실패했습니다',
  'settings.openchamber.cloud.toast.tokenCleared': '웹훅 인증 토큰이 삭제되었습니다',
  ...
  'settings.usage.sidebar.empty.noProvidersConfigured': '아직 설정된 프로바이더가 없습니다.',
  'settings.usage.page.empty.selectProvider': '사용량 세부 정보를 보려면 프로바이더를 선택하세요.',
  'settings.usage.page.empty.noProvidersConfigured': '아직 설정된 프로바이더가 없습니다. 사용량 추적을 시작하려면 프로바이더 탭에서 자격 증명을 추가하세요.',
  ...
  'settings.openchamber.defaults.modelRouter.title': '오토 라우터',
  'settings.openchamber.defaults.modelRouter.description': '모델로 "자동"을 선택하면 간단한 메시지는 저렴한 모델이, 복잡한 메시지는 더 강력한 모델이 처리합니다.',
  'settings.openchamber.defaults.modelRouter.cheapModel': '저비용 등급 모델',
  'settings.openchamber.defaults.modelRouter.cheapModelHint': '작은 모델과 동일',
  'settings.openchamber.defaults.modelRouter.frontierModel': '상위 등급 모델',
  'settings.openchamber.defaults.modelRouter.frontierModelHint': '기본 모델과 동일',
  ...
  'settings.openchamber.defaults.openInApp.title': '열기 위치',
  'settings.openchamber.defaults.openInApp.description': 'OpenChamber에서 프로젝트를 열 때 사용할 기본 앱입니다.',
  'settings.openchamber.defaults.field.defaultOpenInApp': '기본 앱',
  'settings.openchamber.defaults.field.defaultOpenInAppAria': '프로젝트를 열 기본 앱을 선택하세요',
  ...
  'settings.github.page.actions.copyCode': '코드 복사',
  ...
  'settings.github.page.toast.codeCopied': '코드가 클립보드에 복사되었습니다',
  'settings.github.page.toast.copyCodeFailed': '코드를 복사하지 못했습니다',
  ...
  'settings.openchamber.visual.field.showDraftStartersAria': '초안 스타터 표시',
  'settings.openchamber.visual.field.showDraftStarters': '초안 스타터 표시',
  ...
  'settings.openchamber.visual.field.allowSessionSharingAria': '세션 공유 허용',
  'settings.openchamber.visual.field.allowSessionSharing': '세션 공유 허용',
  'settings.openchamber.visual.field.allowSessionSharingHint': '활성화하면 공유 옵션으로 전체 채팅 세션을 OpenCode의 호스팅 서비스에 업로드하고 공개 링크를 생성할 수 있습니다. 기본적으로 비활성화되어 있습니다.',
  ...
  'settings.magicPrompts.page.loading.text': '시스템 프롬프트 불러오는 중...',
  ...
  'settings.magicPrompts.page.toast.loadFailed': '시스템 프롬프트를 불러오지 못했습니다',
  'settings.magicPrompts.page.toast.visiblePromptRequired': '표시 프롬프트는 비워 둘 수 없습니다',
  'settings.magicPrompts.page.toast.saved': '시스템 프롬프트를 저장했습니다',
  'settings.magicPrompts.page.toast.saveFailed': '시스템 프롬프트를 저장하지 못했습니다',
