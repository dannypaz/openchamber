...
export const dict = {
  ...
  'sessions.sidebar.footer.github.connected': 'GitHub connected',
  'sessions.sidebar.footer.github.avatarWithLogin': '{login} avatar',
  'sessions.sidebar.footer.github.avatar': 'GitHub avatar',
  'sessions.sidebar.footer.github.accountsTitle': 'GitHub Accounts',
  ...
  'aboutDialog.actions.updateAvailable': 'Update to {version}',
  ...
  'session.newWorktree.actions.createCloudSession': 'Create Cloud Session',
  'session.newWorktree.actions.provisioning': 'Provisioning...',
  ...
  'session.newWorktree.backend.cloudUnavailableTooltip': "Cloud requires this branch to be pushed to a remote — it isn't yet.",
  ...
  'session.newWorktree.error.noRemoteUrl': "Couldn't determine this repository's remote URL",
  'session.newWorktree.error.cloudProvisioningFailed': 'Failed to provision cloud VM',
  ...
  'session.newWorktree.toast.cloudSessionCreated': 'Cloud session created',
  ...
  'chat.chatInput.draftPicker.newBranchTitle': 'New branch',
  'chat.chatInput.draftPicker.newPlainBranchTitle': 'Create branch',
  'chat.chatInput.worktrees': 'Worktrees',
  'chat.chatInput.worktreeNew': '+ New',
  'chat.chatInput.worktreeNewBranchPlaceholder': 'Branch name',
  'chat.chatInput.worktreeNewBranchAria': 'New branch name',
  'chat.chatInput.branchNew': '+ New',
  'chat.chatInput.toast.createBranchFailed': 'Failed to create branch',
  ...
  'chat.modelControls.instanceSwitcher.openAria': 'Switch instance (current: {current})',
  ...
  'projectActions.actions.discoverActionsTooltip': 'Discover actions',
  ...
  'appUpdate.toast.available.title': 'OpenChamber update available',
  'appUpdate.toast.available.description': 'Version {version} is ready to install.',
  'appUpdate.toast.actions.view': 'View update',
  'appUpdate.toast.actions.dismiss': 'Dismiss',
