export const settingsDict = {
  ...
  'settings.page.magicPrompts.title': 'System Prompts',
  ...
  'settings.page.cloud.title': 'Cloud VMs',
  ...
  'settings.magicPrompts.sidebar.title': 'System Prompts',
  ...
  'settings.openchamber.cloud.title': 'Cloud VMs',
  'settings.openchamber.cloud.tooltip': 'Run a chat session against an ephemeral cloud VM instead of your local machine. Requires your own provisioning infrastructure — OpenChamber only calls the webhooks you configure here.',
  'settings.openchamber.cloud.field.enabled': 'Enable Cloud VMs',
  'settings.openchamber.cloud.field.enabledAria': 'Enable Cloud VMs',
  'settings.openchamber.cloud.field.provisionWebhookUrl': 'Provision Webhook URL',
  'settings.openchamber.cloud.field.provisionWebhookUrlPlaceholder': 'https://infra.example.com/provision',
  'settings.openchamber.cloud.field.destroyWebhookUrl': 'Destroy Webhook URL',
  'settings.openchamber.cloud.field.destroyWebhookUrlPlaceholder': 'https://infra.example.com/destroy',
  'settings.openchamber.cloud.field.webhookAuthToken': 'Webhook Auth Token',
  'settings.openchamber.cloud.field.webhookAuthTokenPlaceholder': 'Enter a token',
  'settings.openchamber.cloud.field.webhookAuthTokenSetPlaceholder': 'Token is set — leave blank to keep it',
  'settings.openchamber.cloud.field.idleTimeoutMinutes': 'Idle Timeout (minutes)',
  'settings.openchamber.cloud.field.maxLifetimeMinutes': 'Max Lifetime (minutes)',
  'settings.openchamber.cloud.actions.save': 'Save',
  'settings.openchamber.cloud.actions.clearToken': 'Clear',
  'settings.openchamber.cloud.toast.saved': 'Cloud VM settings saved',
  'settings.openchamber.cloud.toast.saveFailed': 'Failed to save cloud VM settings',
  'settings.openchamber.cloud.toast.tokenCleared': 'Webhook auth token cleared',
  ...
  'settings.usage.sidebar.empty.noProvidersConfigured': 'No providers set up yet.',
  'settings.usage.page.empty.selectProvider': 'Select a provider to view usage details.',
  'settings.usage.page.empty.noProvidersConfigured': 'No providers are set up yet. Add credentials in the Providers tab to start tracking usage.',
  ...
  'settings.openchamber.defaults.modelRouter.title': 'Auto Router',
  'settings.openchamber.defaults.modelRouter.description': 'When "Auto" is selected as the model, a cheap model handles simple messages and a stronger model handles complex ones.',
  'settings.openchamber.defaults.modelRouter.cheapModel': 'Cheap tier model',
  'settings.openchamber.defaults.modelRouter.cheapModelHint': 'Same as Small Model',
  'settings.openchamber.defaults.modelRouter.frontierModel': 'Frontier tier model',
  'settings.openchamber.defaults.modelRouter.frontierModelHint': 'Same as Default Model',
  ...
  'settings.openchamber.defaults.openInApp.title': 'Open In',
  'settings.openchamber.defaults.openInApp.description': 'Default app used when opening a project from OpenChamber.',
  'settings.openchamber.defaults.field.defaultOpenInApp': 'Default App',
  'settings.openchamber.defaults.field.defaultOpenInAppAria': 'Choose the default app to open projects in',
  ...
  'settings.github.page.actions.copyCode': 'Copy code',
  ...
  'settings.github.page.toast.codeCopied': 'Code copied to clipboard',
  'settings.github.page.toast.copyCodeFailed': 'Failed to copy code',
  ...
  'settings.openchamber.visual.field.showDraftStartersAria': 'Show draft starters',
  'settings.openchamber.visual.field.showDraftStarters': 'Show Draft Starters',
  ...
  'settings.openchamber.visual.field.allowSessionSharingAria': 'Allow session sharing',
  'settings.openchamber.visual.field.allowSessionSharing': 'Allow session sharing',
  'settings.openchamber.visual.field.allowSessionSharingHint': 'When enabled, the Share option can upload a full chat session to OpenCode\'s hosted service and generate a public link. Off by default.',
  ...
  'settings.magicPrompts.page.loading.text': 'Loading System Prompts...',
  ...
  'settings.magicPrompts.page.toast.loadFailed': 'Failed to load System Prompts',
  'settings.magicPrompts.page.toast.visiblePromptRequired': 'Visible prompt cannot be empty',
  'settings.magicPrompts.page.toast.saved': 'System prompt saved',
  'settings.magicPrompts.page.toast.saveFailed': 'Failed to save system prompt',
