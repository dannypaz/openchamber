export const settingsDict = {
  ...
  "settings.page.magicPrompts.title": "Prompts del sistema",
  ...
  "settings.page.cloud.title": "VMs en la nube",
  ...
  "settings.magicPrompts.sidebar.title": "Prompts del sistema",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.openchamber.cloud.title": "VMs en la nube",
  "settings.openchamber.cloud.tooltip": "Ejecuta una sesión de chat en una VM en la nube efímera en lugar de tu equipo local. Requiere tu propia infraestructura de aprovisionamiento: OpenChamber solo llama a los webhooks que configures aquí.",
  "settings.openchamber.cloud.field.enabled": "Activar VMs en la nube",
  "settings.openchamber.cloud.field.enabledAria": "Activar VMs en la nube",
  "settings.openchamber.cloud.field.provisionWebhookUrl": "URL del webhook de aprovisionamiento",
  "settings.openchamber.cloud.field.provisionWebhookUrlPlaceholder": "https://infra.example.com/provision",
  "settings.openchamber.cloud.field.destroyWebhookUrl": "URL del webhook de destrucción",
  "settings.openchamber.cloud.field.destroyWebhookUrlPlaceholder": "https://infra.example.com/destroy",
  "settings.openchamber.cloud.field.webhookAuthToken": "Token de autenticación del webhook",
  "settings.openchamber.cloud.field.webhookAuthTokenPlaceholder": "Introduce un token",
  "settings.openchamber.cloud.field.webhookAuthTokenSetPlaceholder": "El token ya está configurado; déjalo en blanco para conservarlo",
  "settings.openchamber.cloud.field.idleTimeoutMinutes": "Tiempo de inactividad (minutos)",
  "settings.openchamber.cloud.field.maxLifetimeMinutes": "Duración máxima (minutos)",
  "settings.openchamber.cloud.actions.save": "Guardar",
  "settings.openchamber.cloud.actions.clearToken": "Borrar",
  "settings.openchamber.cloud.toast.saved": "Configuración de VMs en la nube guardada",
  "settings.openchamber.cloud.toast.saveFailed": "No se pudo guardar la configuración de VMs en la nube",
  "settings.openchamber.cloud.toast.tokenCleared": "Token de autenticación del webhook eliminado",
  ...
  "settings.usage.sidebar.empty.noProvidersConfigured": "Aún no hay proveedores configurados.",
  "settings.usage.page.empty.selectProvider": "Selecciona un proveedor para ver detalles de uso.",
  "settings.usage.page.empty.noProvidersConfigured": "Aún no hay proveedores configurados. Añade credenciales en la pestaña Proveedores para empezar a rastrear el uso.",
  ...
  "settings.openchamber.defaults.modelRouter.title": "Enrutador automático",
  "settings.openchamber.defaults.modelRouter.description": "Cuando se selecciona \"Auto\" como modelo, un modelo económico gestiona los mensajes simples y un modelo más potente gestiona los complejos.",
  "settings.openchamber.defaults.modelRouter.cheapModel": "Modelo de nivel económico",
  "settings.openchamber.defaults.modelRouter.cheapModelHint": "Igual que el modelo pequeño",
  "settings.openchamber.defaults.modelRouter.frontierModel": "Modelo de nivel avanzado",
  "settings.openchamber.defaults.modelRouter.frontierModelHint": "Igual que el modelo predeterminado",
  ...
  "settings.openchamber.defaults.openInApp.title": "Abrir en",
  "settings.openchamber.defaults.openInApp.description": "Aplicación predeterminada usada al abrir un proyecto desde OpenChamber.",
  "settings.openchamber.defaults.field.defaultOpenInApp": "Aplicación predeterminada",
  "settings.openchamber.defaults.field.defaultOpenInAppAria": "Elige la aplicación predeterminada para abrir proyectos",
  ...
  "settings.github.page.actions.copyCode": "Copiar código",
  ...
  "settings.github.page.toast.codeCopied": "Código copiado al portapapeles",
  "settings.github.page.toast.copyCodeFailed": "No se pudo copiar el código",
  ...
  "settings.openchamber.visual.field.showDraftStartersAria": "Mostrar iniciadores de borrador",
  "settings.openchamber.visual.field.showDraftStarters": "Mostrar iniciadores de borrador",
  ...
  "settings.openchamber.visual.field.allowSessionSharingAria": "Permitir compartir sesiones",
  "settings.openchamber.visual.field.allowSessionSharing": "Permitir compartir sesiones",
  "settings.openchamber.visual.field.allowSessionSharingHint": "Cuando está activado, la opción Compartir puede subir toda una sesión de chat al servicio alojado de OpenCode y generar un enlace público. Desactivado de forma predeterminada.",
  ...
  "settings.magicPrompts.page.loading.text": "Cargando prompts del sistema...",
  ...
  "settings.magicPrompts.page.toast.loadFailed": "No se pudieron cargar los prompts del sistema",
  "settings.magicPrompts.page.toast.visiblePromptRequired": "El prompt visible no puede estar vacío",
  "settings.magicPrompts.page.toast.saved": "Prompt del sistema guardado",
  "settings.magicPrompts.page.toast.saveFailed": "No se pudo guardar el prompt del sistema",
